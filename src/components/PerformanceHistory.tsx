...
// Turn an ISO date into a compact "Today / Yesterday / Mon D" label.
...
const VERDICTS = ["Rough start", "Rough", "Needs work", "Solid take", "Great take", "Scene stealer"];
const verdictFor = (stars: number | null) => (stars == null ? "Not rated" : VERDICTS[stars] ?? "");
      ...
      <button type="button" className="g-card" onClick={() => setOpen(true)}>
        <div className="g-card-inner">
          ...
          <section>
            ...
            <p>Look back at your finished games and the scores they earned.</p>
          </section>
        </div>
      </button>
          ...
          >
            ...
            <p className="g-modal-sub text-center">
              {!loaded ? (
                ...
                <>
                  Your last {entries.length} game{entries.length === 1 ? "" : "s"}
                  {avg != null && (
                    <>
                      {" · avg "}
            ...
            {loaded && entries.length === 0 ? (
              <p className="mt-3 text-center text-[13px] leading-relaxed text-cream/50">
                Finish a party dub and it&apos;ll show up here — with the scene you
                played and the stars the other players gave you.
              </p>
            ) : (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        ...
                        <span className="text-[11px] text-cream/50">{verdictFor(e.stars)}</span>
                      </div>
                    </div>
                  </div>
                ))}
