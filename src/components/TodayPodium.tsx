...
const PILLAR: Record<1 | 2 | 3, { h: number; accent: string }> = {
  1: { h: 84, accent: "#FFD23F" },
  2: { h: 60, accent: "#C9D2E3" },
  3: { h: 44, accent: "#E0975A" },
};
    ...
    <div className="flex w-full flex-col items-center justify-end">
      ...
      <div className="mb-2">
        {clip ? (
          ...
          <div className="grid h-11 w-[72px] place-items-center rounded-[8px] border-2 border-dashed border-violet-lift/70 bg-black/25 font-display text-[9px] font-black uppercase tracking-[0.12em] text-cream/45">
            Soon
          </div>
        )}
      </div>
...
export async function TodayPodium() {
  ...
  return (
    <aside className="g-podium self-stretch">
      <h2 className="g-title">Clips of Today</h2>

      <div className="g-panel relative flex min-h-[200px] flex-1 items-end justify-center">
        ...
        <div className="relative z-10 flex w-full max-w-[420px] items-end justify-center gap-4">
