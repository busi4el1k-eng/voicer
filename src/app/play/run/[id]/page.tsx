...
const matchColor = (pct: number) =>
  pct >= 70 ? "#38a8dc" : pct >= 40 ? "#ffb42e" : "#f9ab4d";
...
export default function SoloRunPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Back-fill the match score for any take that was recorded before the original
  // envelope finished decoding (see sectorReady above) — so not blocking on the
  // decode never costs a score. Runs once the two envelopes for a sector exist.
  useEffect(() => {
